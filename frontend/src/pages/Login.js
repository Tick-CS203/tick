...
export const Login = () => {
  ...
  return (
    ...
    <div className="grid grid-cols-1 h-screen w-full">
      ...
      <img
          className="absolute right-[384px] top-[128px]"
