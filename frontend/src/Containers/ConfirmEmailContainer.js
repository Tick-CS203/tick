...
import EmailConfirmFormWrapper from '../Components/EmailConfirmFormWrapper';
        ...
        <EmailConfirmFormWrapper onSubmit={this.handleSubmit}>
          ...
          <Col md={24} lg={12}>
            <Button type="primary" disabled={loading} htmlType="submit" size="large">
              {loading ? <Spin indicator={<SmileOutlined type="loading" style={{ fontSize: 24 }} spin />} /> : 'Confirm Email'}
            </Button>
          </Col>
